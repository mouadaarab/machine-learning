#!/usr/bin/env python3
"""
Script pour créer et sauvegarder des modèles Random Forest 
entraînés sur les datasets Iris et California Housing.

Ce script crée deux modèles Random Forest :
1. RandomForestClassifier pour la classification des espèces d'iris
2. RandomForestRegressor pour la prédiction des prix immobiliers californiens
"""
...
def create_random_forest_iris_model():
    """
    Crée et sauvegarde un modèle Random Forest pour la classification des espèces d'iris.
    ...
    """
    print("\n" + "="*60)
    print("🌸 Création du modèle Random Forest pour la classification Iris...")
    ...
    info_path = os.path.join(models_dir, 'random_forest_model_info.pkl')
    ...
    return rf_classifier, model_info


def create_random_forest_housing_model():
    """
    Crée et sauvegarde un modèle Random Forest pour la prédiction des prix immobiliers californiens.
    
    Returns:
        RandomForestRegressor: Le modèle entraîné
        dict: Informations sur les performances du modèle
    """
    print("\n" + "="*60)
    print("🏠 Création du modèle Random Forest pour la régression California Housing...")
...
def test_iris_model():
    ...
    """
    print(f"\n🧪 Test du modèle Random Forest Iris...")
    
    model_path = os.path.join('models_ai', 'random_forest_model.pkl')
...
def test_housing_model():
    ...
    """
    print(f"\n🧪 Test du modèle Random Forest California Housing...")
    
    model_path = os.path.join('models_ai', 'california_housing_rf_model.pkl')
...
def main():
    """
    Fonction principale pour créer les modèles Random Forest.
    """
    print("🚀 Création des modèles Random Forest")
    print("=" * 60)
    
    try:
        # Créer le modèle Iris
        iris_model, iris_info = create_random_forest_iris_model()
        
        # Créer le modèle California Housing
        housing_model, housing_info = create_random_forest_housing_model()
        
        # Tester les modèles
        test_iris_model()
        test_housing_model()
        
        print("\n🎉 Tous les modèles Random Forest ont été créés avec succès!")
